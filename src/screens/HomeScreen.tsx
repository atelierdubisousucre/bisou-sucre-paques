...
export default function HomeScreen() {
  ...
  // Sur web : limiter la largeur pour un meilleur rendu desktop
  const contentWidth = IS_WEB ? Math.min(SW, 500) : SW;

  return (
    <LinearGradient colors={['#FFF5F8','#FFE8F0','#FFCFE3','#FFB8D4']} style={s.gradient}>
      <SafeAreaView style={s.safe}>
        <ScrollView
          contentContainerStyle={[s.scroll, IS_WEB && { alignSelf: 'center', width: contentWidth }]}
